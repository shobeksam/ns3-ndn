 ...
 *
 *     NS_LOG=ndn.Consumer:ndn.Producer:ndn.Consumer ./waf --run=ndn-simulation-2
 */
...
int main(int argc, char* argv[])
{
  ...
  consumerHelper.SetPrefix("/data");
  consumerHelper.SetAttribute("StartSeq", IntegerValue(15));    // second consumer 
